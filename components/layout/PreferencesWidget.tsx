...
export function PreferencesWidget() {
  ...
  return (
    <div
      className={cn(
        "fixed bottom-6 right-0 z-50 flex items-center bg-white shadow-[var(--shadow-large)] border border-border border-r-0 transition-all duration-300 ease-[var(--ease-premium)]",
        "rounded-l-3xl overflow-hidden",
        isExpanded ? "w-[280px]" : "w-14 h-14"
      )}
    ...
    >
      <div className="flex items-center w-full h-14">
        ...
        <div className="w-14 h-14 flex items-center justify-center flex-shrink-0 text-text-secondary">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex bg-surface-dark rounded-md overflow-hidden p-0.5">
              {["EN", "TR"].map((lang) => (
                <button
                  key={lang}
